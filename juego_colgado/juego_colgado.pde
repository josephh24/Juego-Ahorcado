...
void setup(){ 
  ...
  gestor = new Minim(this);  //2
  sonido1 = gestor.loadFile("The Good, The Bad And The Ugly Theme.mp3");
  sonido2 = gestor.loadFile("ganar.mp3");
  sonido3 = gestor.loadFile("sad.mp3");
